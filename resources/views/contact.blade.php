        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="mb-4">
                    <h3>
                        +593 964256002
                        <i class="bi bi-clipboard copy-icon" onclick="copyToClipboard('+593 964256002')"
                            title="Copiar número"></i>
                    </h3>
                    <p class="lead">Calle Cuenca,<br> y Guayaquil</p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-end">
                    <p class="mb-0">Loja, El Valle<br> 110101</p>
                </div>
            </div>
            <hr class="my-4">
