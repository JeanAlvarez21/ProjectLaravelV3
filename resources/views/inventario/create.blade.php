...
<head>
    ...
    <title>Crear Item de Inventario - Novocentro</title>
            ...
            <div class="d-flex">
                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <h1 class="mb-4">Crear Nuevo Item de Inventario</h1>
                                @if ($errors->any())
                                ...
                                <form action="{{ route('inventario.store') }}" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-primary">Crear Item de Inventario</button>
                                </form>
                            </div>
                        </div>
                    </div>
