...
<head>
    ...
    <title>Editar Carpintero - Novocentro</title>
...
<body>
    ...
    <main class="container my-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('carpinteros.update', $carpintero->id) }}" method="POST"
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre"
                                value="{{ $carpintero->nombre }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control" id="email" name="email"
                                value="{{ $carpintero->email }}" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="disponibilidad" name="disponibilidad" required>
                                <option value="1" {{ $carpintero->disponibilidad ? 'selected' : '' }}>Disponible
                                </option>
                                <option value="0" {{ !$carpintero->disponibilidad ? 'selected' : '' }}>No Disponible
                                </option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="Text" class="form-control" id="descripcion" name="descripcion"
                                value="{{ $carpintero->descripcion }}" required>
                        </div>
                    </div>
                    <div class="mt-3">
